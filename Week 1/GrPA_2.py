...
# <eoi>
# Write your code below this line (you can add more lines if needed)
...
final1 = price1 * (1 - discount1/100)
final2 = price2 * (1 - discount2/100)
is_offer1_cheaper = (final1 < final2) # bool: True if the offer1 is strictly cheaper
